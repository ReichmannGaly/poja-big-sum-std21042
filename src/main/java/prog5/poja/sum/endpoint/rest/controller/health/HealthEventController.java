package prog5.poja.sum.endpoint.rest.controller.health;

import prog5.poja.sum.PojaGenerated;
import prog5.poja.sum.endpoint.event.EventProducer;
import prog5.poja.sum.endpoint.event.gen.UuidCreated;
import prog5.poja.sum.repository.DummyUuidRepository;
...
import static prog5.poja.sum.endpoint.rest.controller.health.PingController.KO;
